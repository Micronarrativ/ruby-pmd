# spec/pdfmdsort_spec.rb
require 'pdfmd'
require 'pdfmd/pdfmdsort'
require 'fakefs/spec_helpers'

RSpec.describe Pdfmdsort do
  ...
  it 'is getting the author string from the metadata' do
    sort_doc = Pdfmdsort.new
    expect(sort_doc.get_author).to eq 'john_doe'
  end
